...
public class RestApiITest {
	...
	private String getJWTToken() throws ClientProtocolException, IOException {
		HttpPost request = new HttpPost("http://localhost.localdomain:8090/api/auth/login");
	...
	public void checkUser() throws ClientProtocolException, IOException {
		HttpGet request = new HttpGet("http://localhost.localdomain:8090/api/users/get/1");
	...
	public void testPost() throws ClientProtocolException, IOException {
		HttpPost request = new HttpPost("http://localhost.localdomain:8090/api/posts/add");
		if (jwtToken != null) request.addHeader("Authorization", jwtToken);
	...
	public void testIsPostCreated() throws ClientProtocolException, IOException {
		HttpGet request = new HttpGet("http://localhost.localdomain:8090/api/posts/get");
